  ...
  return (
    <div className="page-header">
      ...
      <div className="page-subtitle">
        Hôm nay, SinhvienDungThu, Xem theo: Nhân viên, Thống kê theo: Đi muộn
      </div>
    </div>
  )
}
      ...
      <CTable hover responsive className="mb-0" small>
        <CTableHead>
          <CTableRow>
            ...
            <CTableHeaderCell className="table-header-cell">Số lần (1)</CTableHeaderCell>
...
const LateEarlySummaryPage = () => {
  const [data, setData] = useState([]) // Dữ liệu rỗng để hiện empty state
