...
// =====================================================================
// 0. CẤU HÌNH CỘT (ĐỔI CA - SHIFT SWAP)
// =====================================================================
const DEFAULT_COLUMNS = [
  { key: 'checkbox', label: '', visible: true, width: 50, type: 'checkbox' },
  { key: 'emp_code', label: 'Mã nhân viên', visible: true, width: 120 },
  { key: 'proposer', label: 'Người đề nghị', visible: true, width: 180 },
  { key: 'swap_emp', label: 'NV đổi ca', visible: true, width: 180 },
  { key: 'position', label: 'Vị trí', visible: false, width: 150 },
  { key: 'department', label: 'Đơn vị', visible: true, width: 180 },
  { key: 'request_date', label: 'Ngày đề nghị', visible: true, width: 150, align: 'center' },
  { key: 'work_date', label: 'Ngày làm việc', visible: true, width: 140, align: 'center' },
  { key: 'current_shift', label: 'Ca hiện tại', visible: true, width: 140 },
  { key: 'location', label: 'Địa điểm', visible: false, width: 150 },
  { key: 'swap_date', label: 'Ngày đổi', visible: true, width: 140, align: 'center' },
  { key: 'new_shift', label: 'Ca đổi', visible: true, width: 140 },
  { key: 'swap_with', label: 'Đổi với', visible: true, width: 140 },
  ...
  { key: 'note', label: 'Ghi chú', visible: false, width: 200 },
...
const MOCK_DB = [
  { 
    id: 1, emp_code: 'NV000002', proposer: 'Lâm Lâm', swap_emp: 'Lâm Lâm', 
    position: 'Kế toán trưởng', department: 'Phòng A', request_date: '11/12/2025 17:54', 
    work_date: '11/12/2025', current_shift: 'Ca hành chính', location: 'Văn phòng',
    swap_date: '12/12/2025', new_shift: 'Ca tối', swap_with: '-', 
    reason: 'Bận việc riêng', status: 'Đã duyệt', approver: 'Nguyễn Văn Sếp', note: ''
  },
  { 
    id: 2, emp_code: 'NV000005', proposer: 'Trần Văn B', swap_emp: 'Lê Thị C', 
    position: 'Nhân viên', department: 'Kỹ thuật', request_date: '12/12/2025 08:00', 
    work_date: '13/12/2025', current_shift: 'Ca 1', location: 'Nhà máy',
    swap_date: '13/12/2025', new_shift: 'Ca 2', swap_with: 'Lê Thị C', 
    reason: 'Đổi ca cho nhau', status: 'Chờ duyệt', approver: 'Trần Kỹ Thuật', note: 'Gấp'
  },
];
...
const PageStyles = () => (
  <style>
    ...
    /* ACTIONS HEADER: Đảm bảo khoảng cách giữa các nút */
...
const PageHeader = ({ onImportClick, onAddClick }) => (
  <div className="page-header">
    <div className="page-title">Đề nghị đổi ca</div>
    <div className="header-actions">
        {/* NÚT NHẬP KHẨU (BÊN TRÁI) */}
        <CButton 
            color="secondary" 
            variant="outline" 
            className="fw-semibold bg-white text-dark border-secondary" 
            onClick={onImportClick}
        >
            <CIcon icon={cilCloudUpload} className="me-2" />Nhập khẩu
        </CButton>

        {/* NÚT THÊM (BÊN PHẢI) */}
        <CButton className="btn-orange" onClick={onAddClick}>
      ...
      <div className="filter-right" style={{ position: 'relative' }}>
        ...
        <CDropdown>
            ...
            <CDropdownMenu>
                ...
                <CDropdownItem onClick={() => onFilterChange(p => ({...p, unit: 'Kỹ thuật'}))}>Kỹ thuật</CDropdownItem>
            </CDropdownMenu>
        </CDropdown>
...
const PageTable = ({ data, columns }) => {
  ...
  return (
    <div className="table-wrapper-fullscreen">
      <CTable hover className="mb-0" align="middle" style={{ minWidth: '2200px' }}>
        <CTableHead>
          <CTableRow>
...
const ShiftSwapRequestPage = () => {
  ...
  const fetchData = useCallback(async (currentFilters) => {
    setIsFiltering(true);
    await new Promise(r => setTimeout(r, 300)); // Delay giả lập
  ...
  const handleExportExcel = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'danh_sach_doi_ca.csv');
    ...
    <>
      ...
      <div className="page-container">
        <PageHeader 
            ...
            onAddClick={() => navigate('/timesheet/shiftSwapRequest/add')} 
        />
      ...
      <CModal alignment="center" size="lg" visible={visibleImportModal} onClose={() => setVisibleImportModal(false)}>
        <CModalHeader><CModalTitle className="fw-bold fs-5">Nhập khẩu dữ liệu đổi ca</CModalTitle></CModalHeader>
        <CModalBody>
...
export default ShiftSwapRequestPage;